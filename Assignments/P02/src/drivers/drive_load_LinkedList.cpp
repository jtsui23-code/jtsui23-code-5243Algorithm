...
int main(int argc, char** argv) {
    ...
    if (argc < 3) {
        ...
        cout << "Usage: ./dlinkedlist <workload.json> <results.json>" << endl;
        return 1;
    }
